...
*View the interactive dashboard on Tableau Public → Cyclistic RideShare Case Study Dashboard*
...
Based on the findings above, three recommendations to convert casual riders into annual members:
